...
class SharesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post shares_url, params: { share: { description: @share.description, mcap: @share.mcap, name: @share.name, sector: @share.sector, ticker: @share.ticker } }, as: :json
    end
  ...
  test "should update share" do
    patch share_url(@share), params: { share: { description: @share.description, mcap: @share.mcap, name: @share.name, sector: @share.sector, ticker: @share.ticker } }, as: :json
    assert_response 200
  end
